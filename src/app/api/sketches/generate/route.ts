 ...
 *
 * Response:
 * - imageUrl: string - 생성된 이미지 URL (Supabase Storage)
...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.log("Image generated by Replicate:", replicateImageUrl);
    } catch (genError) {
    ...
    try {
      storageImageUrl = await uploadImageFromUrl(replicateImageUrl, user.id);
      console.log("Image uploaded to Supabase Storage:", storageImageUrl);
    } catch (uploadError) {
